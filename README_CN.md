...
- **[orca-block-manager](https://github.com/luckyoubest2/orca-block-manager)** - 块管理插件：迁移块（可原地保留引用或镜像块）、别名化/去别名化，并支持从已有查询块批量获取操作列表。 [@luckyoubest2](https://github.com/luckyoubest2)
